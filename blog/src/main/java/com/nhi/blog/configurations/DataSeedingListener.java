...
public class DataSeedingListener implements ApplicationListener<ContextRefreshedEvent > {
    ...
    private void addRoleIfMissing(String name,String description){
        if(roleRespository.findByNameContaining(name)==null){
            roleRespository.save(new Role(name,description));
        }
    }
...
//                user.getRoles().add(roleRespository.findByNameContaining(role));
//            }
